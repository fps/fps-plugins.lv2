...
typedef struct {
    ...
    void (*const run)(plugin_t *instance, uint32_t sample_count, plugin_port_inl_t inl, plugin_port_inr_t inr, plugin_port_outl_t outl, plugin_port_outr_t outr, plugin_port_drywet_t drywet, plugin_port_length_t length);
