...
typedef struct {
    float const data;
} plugin_port_analyze1_t;

typedef struct {
    float const data;
} plugin_port_analyze2_t;
...
typedef struct {
    ...
    void (*const run)(plugin_t *instance, uint32_t sample_count, plugin_port_in_t in, plugin_port_out_t out, plugin_port_analyze1_t analyze1, plugin_port_analyze2_t analyze2, plugin_port_apply_t apply);
