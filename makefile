...
CXX_EXTRA_FLAGS ?= -O2 -march=native -mcpu=native -g
...
plugins: 
	...
	g++ -std=c++20 ${CXX_EXTRA_FLAGS} eq_match.cc -pedantic -Wall -Werror -shared -o lv2/fps-plugins.lv2/eq_match.so -lfftw3 -lm
